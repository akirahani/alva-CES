...
<div class="blog">
	...
	<div class="bread">
		...
		<div class="button"><button><a href="them-da">Thêm mới</a></button></div>
		<div class="clear"></div>
	</div>
        ...
        <tbody>
            ...
            foreach ($data_list as $key => $value) 
            {
                ...
                <tr>
                    ...
                    <td class="can-giua">
                    <?php 
                    $arr_picture = json_decode($value->vuong);
                    foreach ($arr_picture as $key_p => $value_p) 
                    {
                        if($value_p!='')
                        {
                            echo '<img src="../uploads/van-da/'.$value_p.'" height="40"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
                        }
                    }
                    ?>
                    </td>
                    ...
                    <td class="can-giua">
                        <a href="sua-da?id=<?=$value->id?>&page=<?=$page_get?>"><i class="fal fa-edit"></i></a>
                        <a onClick="return confirm('Bạn muốn xóa?')" href="xoa-da?id=<?=$value->id?>&page=<?=$page_get?>"><i class="fal fa-trash-alt"></i></a>
                    </td>
                </tr>
                <?php
                $thutu ++;
