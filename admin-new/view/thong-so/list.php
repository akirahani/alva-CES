...
<div class="blog medium">
	...
	<div class="bread">
		...
		<div class="button"><button><a href="them-thong-so">Thêm mới</a></button></div>
		<div class="clear"></div>
	</div>
        ...
        <tbody>
            ...
            { 
                ...
                <tr>
                    ...
                    <td class="can-giua">
                        <a href="sua-thong-so?id=<?=$value->id?>"><i class="fal fa-edit"></i></a>
                        <a onClick="return confirm('Bạn muốn xóa?')" href="xoa-thong-so?id=<?=$value->id?>"><i class="fal fa-trash-alt"></i></a>
                    </td>
                </tr>
                <?php
                $thutu ++;
