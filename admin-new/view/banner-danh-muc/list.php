 			...
 			foreach ($data_list as $key => $value) 
			{
				...
				?>
					<tr>
			            ...
			            <td class="can-giua">
			            	<a href="sua-banner-danh-muc?id=<?=$value->id?>"><i class="fas fa-pencil"></i></a>
	                    	<a onClick="return confirm('Are you sure?')" href="xoa-banner-danh-muc?id=<?=$value->id?>"><i class="fal fa-trash-alt"></i></a>
	                    </td>
			        </tr>
				<?php
				$thutu++;
