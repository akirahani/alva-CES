 			...
 			foreach ($data_list as $key => $value) 
			{
				?>
					<tr>
			            ...
			            <td class="can-giua">
			            	<a href="sua-dung-tich?id=<?=$value->id?>"><i class="fas fa-pencil"></i></a>
	                    	<a onClick="return confirm('Are you sure?')" href="xoa-dung-tich?id=<?=$value->id?>"><i class="fal fa-trash-alt"></i></a>
	                    </td>
			        </tr>
				<?php
				$thutu++;
